...
def extract_features_super(url):
    ...
    features['nb_qm'] = urlfe.count_exclamation(url)  
    features['nb_and'] = urlfe.count_and(url) 
    features['nb_or'] = urlfe.count_or(url) 
    features['nb_eq'] = urlfe.count_equal(url)  
    features['nb_underscore'] = urlfe.count_underscore(url)  
    features['nb_tilde'] = urlfe.count_tilde(url) 
    features['nb_percent'] = urlfe.count_percentage(url) 
